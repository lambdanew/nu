...
func TestBlake128(t *testing.T) {
	...
	expected, err := HexToBytes("0x440973e4e50902f1d0ec97de357eb2fd")
	require.NoError(t, err)
	require.Equal(t, expected, h)
}
...
func TestBlake2bHash_EmptyHash(t *testing.T) {
	...
	expected, err := HexToHash("0x0e5751c026e543b2e8ab2eb06099daa1d1e5df47778f7787faab45cdf12fe3a8")
	require.NoError(t, err)
	require.Equal(t, expected, h)
}
...
func TestKeccak256(t *testing.T) {
	...
	expected, err := HexToHash("0xd517392f8119f79c1623774b9346e00104a1d193f1fa641e6e659bf323c37967")
	require.NoError(t, err)
	require.Equal(t, expected, h)
}
